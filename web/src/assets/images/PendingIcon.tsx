...
export const PendingIcon: React.FC<PendingIconProps> = (props: PendingIconProps) => (
    <svg
        ...
        <path
            ...
            fill="var(--system-yellow)"
        />
        <path d="M9.75 20.5833H10.8333V21.6667H9.75V20.5833Z" fill="var(--system-yellow)" />
        <path d="M12.458 20.5833H13.5413V21.6667H12.458V20.5833Z" fill="var(--system-yellow)" />
        <path d="M15.167 20.5833H16.2503V21.6667H15.167V20.5833Z" fill="var(--system-yellow)" />
    </svg>
);
