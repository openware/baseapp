...
const BeneficiariesComponent: React.FC<Props> = (props: Props) => {
    ...
    const [tab, setTab] = React.useState(
        formatMessage({ id: 'page.body.wallets.beneficiaries.tab.panel.add.whitelisted' }),
    );
    ...
    const uniqueBlockchainKeys = React.useMemo(
                    ...
                    <div className="pg-beneficiaries__dropdown">
                        <div
                            ...
                            <div className="select__left">
                                ...
                                <span className="select__left__title">
                                    {formatMessage({
                                        id: 'page.body.wallets.beneficiaries.dropdown.fiat.fullName',
                                    })}
                                </span>
                                <span className="select__left__address">
                                    {currentBeneficiary.data
                                        ? (currentBeneficiary.data as BeneficiaryBank).full_name
                                        : ''}
                                </span>
                            </div>
            ...
            return (
                <div className="pg-beneficiaries__dropdown">
                    <div
                        ...
                        onClick={handleClickToggleAddAddressModal()}>
                        <div className="select__left">
                            <span className="select__left__title">{currentWithdrawalBeneficiary.name}</span>
                            <span className="select__left__address">
                                <span>{address}</span>
                            </span>
    ...
    const renderTitle = React.useMemo(() => {
        if (isOpenConfirmationModal) {
            return formatMessage({
                id: 'page.body.wallets.beneficiaries.title.confirm.new.account',
            });
        }
                ...
                <div className="cr-email-form__options-group">
                    <div className="cr-email-form__option">
                        <div className="cr-email-form__option-inner">
                            <LogoIcon />
                            <HugeCloseIcon
                                className="cr-email-form__option-inner-close"
    ...
    return (
        <div className="pg-beneficiaries">
            ...
            currentWithdrawalBeneficiary.currency === beneficiaries[0].currency
