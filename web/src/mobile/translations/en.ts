export const en = {
    ...
    'page.mobile.orders.header.orderType.buy.stop_loss': 'Stop loss',
    'page.mobile.orders.header.orderType.sell.take_profit': 'Take profit',
    'page.mobile.orders.header.orderType.buy.stop_limit': 'Stop limit',
