...
interface State {
    ...
    logo: LogoInterface | undefined;
    currentFont: ThemeFontInterface | undefined;
}
...
class CustomizationContainer extends React.Component<Props, State> {
        ...
        return [
            ...
            },
            {
                content: currentTabIndex === 1 ? (
                    <CustomizationFonts
                        resetToDefault={resetToDefault}
                        handleSetFont={this.handleUpdateState('currentFont')}
                        translate={this.translate}
                    />
                ) : null,
            ...
            },
            {
                content: currentTabIndex === 3 ? (
                    <CustomizationImages
                        handleUpdateImage={this.handleUpdateState}
                        resetToDefault={resetToDefault}
                        translate={this.translate}
                    />
                ) : null,
    ...
    private handleClickSaveButton = () => {
        const { currentThemeId, currentFont, logo } = this.state;
...
export const ThemeSidebar = injectIntl(withRouter(connect(mapStateToProps, mapDispatchProps)(CustomizationContainer) as any) as any);
