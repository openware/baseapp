        ...
        switch (type) {
            case 'deposits':
                return [
                    ...
                    this.props.intl.formatMessage({
                        id: 'page.body.history.deposit.header.blockchain',
                    }),
            ...
            case 'withdraws':
                return [
                    ...
                    this.props.intl.formatMessage({
                        id: 'page.body.history.withdraw.header.blockchain',
                    }),
            ...
            case 'transfers':
                return [
                    ...
                    this.props.intl.formatMessage({
                        id: 'page.body.history.transfer.header.amount',
                    }),
                    this.props.intl.formatMessage({
                        id: 'page.body.history.transfer.header.currency',
                    }),
                    this.props.intl.formatMessage({
                        id: 'page.body.history.transfer.header.direction',
                    }),
                    this.props.intl.formatMessage({
                        id: 'page.body.history.transfer.header.toAccount',
                    }),
                    this.props.intl.formatMessage({
                        id: 'page.body.history.transfer.header.status',
                    }),
                ];
            case 'quick_exchange':
                return [
                    ...
                    this.props.intl.formatMessage({
                        id: 'page.body.history.quick.header.amountGive',
                    }),
                    this.props.intl.formatMessage({
                        id: 'page.body.history.quick.header.currencyGive',
                    }),
                    this.props.intl.formatMessage({
                        id: 'page.body.history.quick.header.amountReceive',
                    }),
                    this.props.intl.formatMessage({
                        id: 'page.body.history.quick.header.currencyReceive',
                    }),
    ...
    private renderTableRow = (type, item) => {
        ...
        switch (type) {
            ...
            case 'quick_exchange': {
                ...
                return [
                    localeDate(created_at, 'fullDate'),
                    <Decimal key={id} fixed={data.givePrecision} thousSep=",">
                        {data.amountGive}
                    </Decimal>,
                    data.currencyGive,
                    <Decimal key={id} fixed={data.receivePrecision} thousSep=",">
                        {data.amountReceive}
                    </Decimal>,
                    data.currencyReceive,
                    <span style={{ color: setTransferStatusColor(state) }} key={id}>
                        {state}
                    </span>,
                ];
            }
