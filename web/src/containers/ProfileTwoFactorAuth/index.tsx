...
export const ProfileTwoFactorAuth = (props) => {
    ...
    const className = is2faEnabled ? 'pg-profile-page__label-value__enabled' : 'pg-profile-page__label-value__disabled';
    ...
    return (
        <React.Fragment>
            ...
            <Form>
                <Form.Check type="switch" id="2fa-switch" label="" onChange={handleToggle2fa} checked={is2faEnabled} />
            </Form>
        </React.Fragment>
    );
};
