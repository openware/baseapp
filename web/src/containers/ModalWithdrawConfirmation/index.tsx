...
import { CodeVerification, Decimal, Modal } from '../../components';
        ...
        return (
            <div className="pg-exchange-modal-submit-body modal-body__withdraw-confirm">
                ...
                <div className="modal-body__withdraw-confirm-address">
                    <span>{this.translate('page.body.wallets.tabs.withdraw.modal.withdrawTo')}</span>
                    <div className="modal-body__withdraw-confirm-address-row bold-text">{rid}</div>
                </div>
                <div className="modal-body__withdraw-confirm-name">
                    <span>{this.translate('page.body.wallets.tabs.withdraw.modal.name')}</span>
                    <div className="modal-body__withdraw-confirm-address-row bold-text">{beneficiary.name}</div>
                </div>
                {beneficiary.protocol || protocol ? (
                    <div className="modal-body__withdraw-confirm-name">
                        <span>{this.translate('page.body.wallets.withdraw.blockchain.network')}</span>
                ...
                <div className="modal-body__withdraw-confirm-inline">
                    <span>{this.translate('page.body.wallets.tabs.withdraw.modal.amount')}</span>
                    <p>
                        <span className="bold-text">{Decimal.format(amount, precision, ',')}</span> {formattedCurrency}
                    </p>
                </div>
                <div className="modal-body__withdraw-confirm-inline">
                    <span>{this.translate('page.body.wallets.tabs.withdraw.modal.fee')}</span>
                    <p>
                ...
                <div className="modal-body__withdraw-confirm-block">
                    <div>{this.translate('page.body.wallets.tabs.withdraw.modal.total')}</div>
        ...
        return (
            <div className="pg-exchange-modal-submit-footer modal-footer__withdraw-confirm">
                <div className="modal-footer__withdraw-confirm-verification">
                    {this.translate('page.body.wallets.tabs.withdraw.modal.verification')}
                </div>
