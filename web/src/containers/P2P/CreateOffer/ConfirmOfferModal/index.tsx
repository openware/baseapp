            ...
            <div className="form-padding">
                <div className="cr-create-offer__modal">
                    <div className="cr-create-offer__modal-item">
                        <span className="cr-create-offer__modal-item__label">
                            {translate('page.body.p2p.create.offer.type')}
                        </span>
                        <span className="cr-create-offer__modal-item__value">{side?.toUpperCase()}</span>
                    </div>
                    <div className="cr-create-offer__modal-item">
                        <span className="cr-create-offer__modal-item__label">
                            {translate('page.body.p2p.create.offer.asset')}
                        </span>
                        <span className="cr-create-offer__modal-item__value">{asset?.id.toUpperCase()}</span>
                    </div>
                    <div className="cr-create-offer__modal-item">
                        <span className="cr-create-offer__modal-item__label">
                            {translate('page.body.p2p.create.offer.currency')}
                        </span>
                        <span className="cr-create-offer__modal-item__value">{cash?.id.toUpperCase()}</span>
                    </div>
                    <div className="cr-create-offer__modal-item">
                        <span className="cr-create-offer__modal-item__label">
                            {translate('page.body.p2p.create.offer.price')}
                        </span>
                        <span className="cr-create-offer__modal-item__value">
                            {Decimal.format(price, cash.precision, ',')}&nbsp;
                            {cash?.id.toUpperCase()}
                        </span>
                    </div>
                    <div className="cr-create-offer__modal-item">
                        <span className="cr-create-offer__modal-item__label">
                            {translate('page.body.p2p.create.offer.amount')}
                        </span>
                        <span className="cr-create-offer__modal-item__value">
                            {Decimal.format(amount, asset.precision, ',')}&nbsp;
                            {asset?.id.toUpperCase()}
                        </span>
                    </div>
                    <div className="cr-create-offer__modal-item">
                        <span className="cr-create-offer__modal-item__label">
                            {translate('page.body.p2p.create.offer.order_limit')}
                        </span>
                        <span className="cr-create-offer__modal-item__value">
                            {Decimal.format(lowLimit, cash.precision, ',')}&nbsp;
                            {cash?.id.toUpperCase()} - {Decimal.format(topLimit, cash.precision, ',')}&nbsp;
                            {cash?.id.toUpperCase()}
                        </span>
                    </div>
                    <div className="cr-create-offer__modal-item">
                        ...
                        {paymentMethods.map((i) => (
                            <span className="cr-create-offer__modal-item__value">{i.payment_method?.name}</span>
                        ))}
                    </div>
                    <div className="cr-create-offer__modal-item">
                        <span className="cr-create-offer__modal-item__label">
                ...
                <div className="cr-create-offer__modal--info">
                    {translate('page.body.p2p.create.offer.confirm.info', {
    ...
    const footer = useMemo(
        () => (
            <div className="cr-create-offer__btn-wrapper__grid">
                <Button onClick={props.toggleModal} size="lg" variant="secondary">
