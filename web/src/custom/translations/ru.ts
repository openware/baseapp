...
export const ru: LangType = {
    ...
    'page.body.p2p.order.transfer.order.wait.timeout.ok': 'OK',
    'page.body.p2p.order.transfer.order.wait.timeout.title': 'P2P TIMEOUT',
    'page.body.p2p.order.transfer.order.wait.timeout.detail': 'Order has been cancelled automatically.',
