...
export const ru: LangType = {
    ...
    'page.body.p2p.order.transfer.order.wait.timer.buy': 'Payment to be made',
    'page.body.p2p.order.transfer.order.wait.timer.sell': 'Time to confirm',
    'page.body.p2p.order.transfer.order.wait.warning.buy': 'Please make a payment within {time} mins, otherwise, the order will be cancelled.',
    'page.body.p2p.order.transfer.order.wait.warning.sell': 'Please confirm that you have received funds to your bank account.',

    'page.body.p2p.order.transfer.order.wait.confirm.checkbox.buy': 'I have transferred {amount} to the seller’s account',
    'page.body.p2p.order.transfer.order.wait.confirm.checkbox.sell': 'I have received {amount} to my bank account',
    ...
    'page.body.p2p.order.transfer.order.wait.sell.info': 'Buyer has confirmed the payment',    
    ...
    'page.body.p2p.order.transfer.wait.payment.confirmation.buy': 'Order paid',
    'page.body.p2p.order.transfer.wait.payment.confirmation.sell': 'Waiting for buyer\'s payment confirmation.',
    'page.body.p2p.order.transfer.wait.payment.confirmation.buy.desc': 'You have paid. Wait for the seller\'s payment confirmation before releasing the crypto. It may take {time} min',
    'page.body.p2p.order.transfer.wait.payment.confirmation.sell.desc': 'Wait for the buyer\'s payment confirmation before. It may take {time} min.',
    'page.body.p2p.order.transfer.wait.payment.confirmation.timer.buy': 'Seller confirmation pending',
    ...
    'page.body.p2p.order.transfer.wait.payment.confirmation.warning.sell': 'Waiting for confirmation. Time limit: {time} mins, otherwise, the order will be cancelled.',
