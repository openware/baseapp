...
/* P2P Currencies */
export const selectP2PCurrenciesData = (state: RootState): P2PCurrency[] =>
    state.public.p2p.currencies.data;

export const selectP2PCurrenciesLoading = (state: RootState): boolean =>
    state.public.p2p.currencies.fetching;

export const selectP2PCurrenciesSuccess = (state: RootState): boolean =>
    state.public.p2p.currencies.success;
