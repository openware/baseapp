...
export const selectWithdrawLimits = (state: RootState): WithdrawLimits[] => state.public.withdrawLimits.data;

export const selectWithdrawLimitsLoading = (state: RootState): boolean => state.public.withdrawLimits.loading;

export const selectWithdrawLimitsSuccess = (state: RootState): boolean => state.public.withdrawLimits.success;
