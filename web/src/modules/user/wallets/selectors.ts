...
export const selectP2PWalletsLoading = (state: RootState): boolean => state.user.wallets.p2pWallets.loading;
...
export const selectP2PWallets = (state: RootState): Wallet[] => state.user.wallets.p2pWallets.list;
