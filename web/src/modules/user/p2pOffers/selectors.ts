...
export const selectP2PUserOffers = (state: RootState): Offer[] => state.user.p2pOffers.offers.list;

export const selectP2PUserOffersFetchLoading = (state: RootState): boolean => state.user.p2pOffers.offers.fetching;

export const selectP2PUserOffersFetchSuccess = (state: RootState): boolean => state.user.p2pOffers.offers.success;
...
export const selectP2PUserOffersTotalNumber = (state: RootState): number => state.user.p2pOffers.offers.total;

export const selectP2PUserOffersCurrentPage = (state: RootState): number => state.user.p2pOffers.offers.page;
...
export const selectP2PUserOfferOrders = (state: RootState): OfferNestedOrders => state.user.p2pOffers.offerOrders.data;
...
/* P2P Create Offer */
export const selectP2PCreateOffersLoading = (state: RootState): boolean => state.user.p2pOffers.createOffer.loading;

export const selectP2PCreateOffersSuccess = (state: RootState): boolean => state.user.p2pOffers.createOffer.success;
...
export const selectP2PCancelOfferData = (state: RootState): Offer[] => state.user.p2pOffers.cancelOffer.list;

export const selectP2PCancelOfferLoading = (state: RootState): boolean => state.user.p2pOffers.cancelOffer.loading;

export const selectP2PCancelOfferSuccess = (state: RootState): boolean => state.user.p2pOffers.cancelOffer.success;
