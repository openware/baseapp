...
import { P2P_ORDER_FETCH, P2P_ORDERS_CREATE_FETCH, P2P_TRADES_HISTORY_FETCH, P2P_ORDERS_CANCEL_FETCH } from '../constants';
...
export function* rootP2POrdersSaga() {
    ...
    yield takeLatest(P2P_ORDERS_CANCEL_FETCH, cancelOrderSaga);
}
