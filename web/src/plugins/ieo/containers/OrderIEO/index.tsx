...
interface DispatchProps {
    ...
    ieoOrdersPush: typeof ieoOrdersPush;
    executeIEOOrder: typeof ieoOrderExecuteFetch;
}
...
class OrderIEOContainer extends React.PureComponent<Props> {
    ...
    private getOrder = () => {
        const { currentIEO, wallets, currencies } = this.props;
        ...
        const currency = currencies.find(item => item.id === currentIEO.currency_id);
        const precision = (ieoFields.metadata && currentIEO.metadata && currentIEO.metadata.precision) || (currency && currency.precision) || 0;
        ...
        return (
            <OrderForm
                ...
                currentMarketAskPrecision={+precision}
