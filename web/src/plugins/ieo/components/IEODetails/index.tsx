...
class IEODetailsComponent extends React.Component<Props> {
    ...
    public render() {
        ...
        const quoteCurrency = currencies.length && currentIEO.pairs[0].quote_currency_id && currencies.find(currency => (currency.id && currency.id.toLowerCase() === currentIEO.pairs[0].quote_currency_id.toLowerCase()) || false);
                ...
                <div className="ieo-profile-details__body">
                    <div className="ieo-profile-details__body__left">
                        ...
                        <div className="ieo-profile-details__body__left__row">
                            ...
                            <div className="ieo-profile-details__body__left__row__second-column">
                                {currentIEO.metadata ? `${Decimal.format(currentIEO.supply, +((currentIEO.metadata && currentIEO.metadata.precision) || 0))} ${currentIEO.currency_id && currentIEO.currency_id.toUpperCase()}` : '-'}
                            </div>
                        </div>
                        <div className="ieo-profile-details__body__left__row">
                            <div className="ieo-profile-details__body__left__row__first-column">
                            ...
                            <div className="ieo-profile-details__body__left__row__second-column">
                                {currentIEO.metadata ? `${Decimal.format(currentIEO.metadata.total_supply, +((currentIEO.metadata && currentIEO.metadata.precision) || 0))} ${currentIEO.currency_id && currentIEO.currency_id.toUpperCase()}` : '-'}
                            </div>
                        </div>
                        <div className="ieo-profile-details__body__left__row">
                            <div className="ieo-profile-details__body__left__row__first-column">
                        ...
                        <div className="ieo-profile-details__body__left__row">
                            ...
                            <div className="ieo-profile-details__body__left__row__second-column">
                                {currentIEO.metadata ? `${Decimal.format(currentIEO.min_amount, +((currentIEO.metadata && currentIEO.metadata.precision) || 0))} ${currentIEO.currency_id && currentIEO.currency_id.toUpperCase()}` : '-'}
                            </div>
                        </div>
                        <div className="ieo-profile-details__body__left__row">
                            <div className="ieo-profile-details__body__left__row__first-column">
