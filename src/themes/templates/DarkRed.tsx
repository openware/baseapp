...
export const DarkRedTheme: ThemeColorInterface[] = [
    ...
    { key: '--rgb-subheader-background-color', value: '30, 30, 30' },
    { key: '--rgb-dropdown-background-color', value: '125, 19, 23' },
    { key: '--rgb-icons', value: '115, 127, 146' },
    { key: '--rgb-primary-cta-color', value: '214, 32, 39' },
    { key: '--rgb-contrast-cta-color', value: '214, 32, 39' },
    { key: '--rgb-secondary-contrast-cta-color', value: '115, 127, 146' },
    { key: '--rgb-cta-layer-color', value: '30, 30, 30' },
    ...
    { key: '--rgb-divider-color', value: '214, 32, 39' },
    { key: '--rgb-shadow-color', value: '214, 32, 39' },
