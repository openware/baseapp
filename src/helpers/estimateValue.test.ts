...
describe('estimateValue', () => {
    const currencies = [{id: 'eth', precision: 5}, {id: 'usd', precision: 4}, {id: 'btc', precision: 3}, {id: 'zar', precision: 8}] as Currency[];
    ...
    it('should convert single value', () => {
        ...
        expect(estimateUnitValue(targetCurrency, currentCurrency, total, currencies, markets, marketTickers)).toEqual('2.000');
    });
    ...
    it('should convert from small value', () => {
        ...
        expect(estimateUnitValue(targetCurrency, currentCurrency, total, currencies, markets, marketTickers)).toEqual('0.002');
    });
    ...
    it('should convert to small value', () => {
        ...
        expect(estimateUnitValue(targetCurrency, currentCurrency, total, currencies, markets, marketTickers)).toEqual('0.00000001');
    });
