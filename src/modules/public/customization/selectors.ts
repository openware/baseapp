...
export const selectCustomizationSuccess = (state: RootState): boolean => state.public.customization.success;

export const selectCustomizationLoading = (state: RootState): boolean => state.public.customization.loading;

export const selectCustomizationError = (state: RootState): CommonError | undefined => state.public.customization.error;
