...
describe('Api Keys reducers', () => {
    ...
    it('should handle API_KEY_CREATE', () => {
        ...
        const expectedState = {...initialApiKeysState, apiKeys: [payload], modal: {...initialApiKeysState.modal, success: true}};
    ...
    it('should handle API_KEY_DELETE', () => {
        ...
        const expectedState = {...initialApiKeysState, apiKeys: [], modal: {...initialApiKeysState.modal, success: true}};
        expect(apiKeysReducer({
            ...initialApiKeysState,
    ...
    it('should handle API_KEYS_2FA_MODAL', () => {
        ...
        const expectedState = {...initialApiKeysState, modal: {active: false, success: true}};
        expect(apiKeysReducer({
            ...initialApiKeysState,
            modal: {active: true},
