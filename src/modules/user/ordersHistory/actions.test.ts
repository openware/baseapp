...
describe('Orders History actions', () => {
    ...
    it('should check ordersHistoryCancelFetch action creator', () => {
        ...
        const expectedAction = { type: 'orders/ORDERS_HISTORY_CANCEL_FETCH', payload };
    ...
    it('should check ordersHistoryCancelData action creator', () => {
        const payload = [];
        const expectedAction = { type: 'orders/ORDERS_HISTORY_CANCEL_DATA', payload };
    ...
    it('should check ordersHistoryCancelError action creator', () => {
        const expectedAction = { type: 'orders/ORDERS_HISTORY_CANCEL_ERROR' };
