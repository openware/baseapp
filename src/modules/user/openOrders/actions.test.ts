...
describe('Open Orders actions', () => {
    ...
    it('should check userOpenOrdersReset action creator', () => {
        const expectedAction = {type: 'openOrders/USER_OPEN_ORDERS_RESET'};
