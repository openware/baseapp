        ...
        const statusMapping = {
            succeed: (
                <span className="cr-mobile-history-table--success">
                    {intl.formatMessage({ id: 'page.body.history.withdraw.content.status.succeed' })}
                </span>
            ),
            failed: (
            ...
            accepted: (
                <span className="cr-mobile-history-table--success">
                    {intl.formatMessage({ id: 'page.body.history.deposit.content.status.accepted' })}
                </span>
            ),
            collected: (
                <span className="cr-mobile-history-table--success">
                    {intl.formatMessage({ id: 'page.body.history.deposit.content.status.collected' })}
                </span>
            ),
            canceled: (
                <span className="cr-mobile-history-table--failed">
                    {intl.formatMessage({ id: 'page.body.history.deposit.content.status.canceled' })}
                </span>
            ),
            rejected: (
                <span className="cr-mobile-history-table--failed">
                    {intl.formatMessage({ id: 'page.body.history.deposit.content.status.rejected' })}
                </span>
            ),
            processing: (
