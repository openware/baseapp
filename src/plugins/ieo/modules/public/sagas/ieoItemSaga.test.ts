...
import { fetchItemIEO, ieoItemData, ieoItemError } from '../actions';

const debug = false;

describe('Get IEO item', () => {
    ...
    describe('Fetch IEO data', () => {
        ...
        const mockIEOFetch = () => {
            mockAxios.onGet('/public/ieo/sales/331').reply(200, payload);
        };
        ...
        const expectedActionsError = [
            fetchItemIEO(fakeId),
            ieoItemError({ code: 500, message: ['Server error'] }),
        ];
